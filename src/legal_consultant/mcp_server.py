...
def consulenza_legale() -> str:
    ...
    return (
        ...
        "1. Se la domanda puo' ricadere in piu' discipline o procedure distinte (es. piu' "
        "tipi di sanzione, rami del diritto con termini e organi diversi), chiedi prima "
        "un chiarimento invece di scegliere un'interpretazione arbitraria.\n"
        "2. Per ogni domanda di diritto chiama `cerca_normativa` con i concetti "
        ...
        "3. Rispondi solo sulla base degli estratti restituiti. Cita sempre atto e "
        "articolo con il loro URN e, per le disposizioni brevi, riportane anche il testo "
        "letterale tra virgolette oltre alla sintesi. Se una norma non e' nel corpus, "
        "dichiaralo e non cercarla sul web: suggerisci di verificarla su Normattiva.\n"
        "4. Usa `info_corpus` per dire quanto e' aggiornata la base normativa quando "
        "la freschezza e' rilevante.\n"
        f"5. Chiudi sempre con il disclaimer: {DISCLAIMER}"
    )
